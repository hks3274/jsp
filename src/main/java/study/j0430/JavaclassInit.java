...
@WebServlet(urlPatterns = "/GreenJavaClassInit", initParams = {@WebInitParam(name = "mid", value ="hkd1234"),@WebInitParam(name = "pwd", value ="12345678"),@WebInitParam(name = "className", value ="자재과")})
