    ...
    <ul class="navbar-nav">
      ...
      <c:if test="${level <= 4 && (level > 1 || level == 0)}">
	      ...
	      <li class="nav-item mr-3"> 
	         	<div class="dropdown">
	    			<button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown">Study</button>
	      ...
	      <li class="nav-item mr-3"> 
	         	<div class="dropdown">
	    			<button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown">Study2</button>
	    			<div class="dropdown-menu">
      ...
      <c:if test="${level <= 4}">
	      <li class="nav-item mr-3"> 
	         	<div class="dropdown">
	    			<button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown">MyPage</button>
	    			<div class="dropdown-menu">
