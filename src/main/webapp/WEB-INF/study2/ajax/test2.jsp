...
<div class = "container">
	...
	<h2>AJAX 값 전달 연습</h2>
		<form name ="myform">
			...
			<div>
				<input type ="button" value ="아이디검색1" onclick="idCheck1()" class="btn btn-success mt-3 mr-3"/>
				<input type ="button" value ="아이디검색2" onclick="idCheck2()" class="btn btn-primary mt-3 mr-3"/>
				<input type ="button" value ="아이디검색3" onclick="idCheck3()" class="btn btn-info mt-3 mr-3"/>
				<input type ="button" value ="아이디검색4" onclick="idCheck4()" class="btn btn-secondary mt-3 mr-3"/>
			</div>			
		</form>
		<hr/>
