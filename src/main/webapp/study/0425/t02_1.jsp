	...
	<script>
		...
		function fCheck() {
			...
			if(name.value.trim() ==""){
				...
				/* myform.submit(); */
				location.href="t02Ok.jsp?name="+name.value+"&age="+age.value+"&user="+user.value+""; //get방식
				/* location.href=`t02Ok.jsp?name=${name.value}&age=${age.value}"` //서버에서는 백킷사용불가.... */
			}
		}
...
<div class = "container">
	...
	<!-- <form name = "myform" method = "get" action="t02Ok.jsp"> -->
		...
		<div>나이
			<input type = "number" name = "age" id = "age" value="20" class = "form-control mb-3" required/>
		</div>
		<div>
