...
<div class = "container">
    ...
    <table class="table table-bordered text-center">
      ...
      <tr>
        <th>나이</th>
        <td><input type="number" name="age" value="20" required class="form-control"/></td>
      </tr>
      <tr>
        <th>성별</th>
        <td>
      ...
      <tr>
        <td colspan="2">
          ...
          <input type="button" value="돌아가기" onclick="location.href='login.jsp';"  class="btn btn-success mr-2"/>
        </td>
      </tr>
    </table>
  </form>
