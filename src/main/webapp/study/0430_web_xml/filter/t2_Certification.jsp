...
<div class = "container">
	...
	<form name="myform">
		<div><input type ="text" name ="certification" value ="1234" class ="form-control mt-3" /></div>
		<div><input type="button" value="인증코드발급" onclick="certificationCheck()" class="btn btn-success form-control mt-3" /></div>
	</form>
</div>
<p><br/></p>
