...
<div class="container">
	<h2>비밀번호 암호화 연습</h2>
	<pre>
		암호화에서 솔트(salt)는 데이터, 비밀번호, 통과암호를 해서 처리하는 단방향처리함수의 추가 입력으로 사용되는 랜덤 데이터이다.
		솔트는 스토리지에서 비밀번호를 보호하기 위해 사용된다.
		솔트는 레인보우 테이블(rainbow table: 해시테이블)과 같이 미리 계산된 테이블을 사용해서 공격을 방어한다.
	</pre>
  ...
  <div>비밀번호 전송 후 콘솔창에서 암호화된 비밀번호를 확인하세요.</div>
</div>
<p><br/></p>
